                                ...
                                <div class="col-md-12">
                                    <form action="" id="update_account">
                                        ...
                                        <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control" name="job" value="<?php echo $_SESSION['bio']['job'] ?>" required >
                                            </div>
                                            <div class="col-md-5">
                                                <label for="" class="control-label">company</label>
                                                <textarea name="company" id="" cols="30" rows="3" class="form-control"><?php echo $_SESSION['bio']['company'] ?></textarea>
                                            </div>
                                            <div class="col-md-5">

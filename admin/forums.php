							...
							<tbody>
								...
								while($row=$Forum->fetch_assoc()):
									 $trans = get_html_translation_table(HTML_ENTITIES,ENT_QUOTES);
								        ...
								        $count_comments=0;
								        $count_comments = $conn->query("SELECT count(*) FROM forum_comments where topic_id = ".$row['id'])->num_rows;
								?>
								<tr>
...
<script>
	...
	$('.edit_forum').click(function(){
		uni_modal("forum","manage_forum.php?id="+$(this).attr('data-id'),'mid-large')

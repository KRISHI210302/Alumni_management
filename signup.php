                                ...
                                <div class="col-md-12">
                                    <form action="" id="create_account">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">job descripition</label>
                                                <input type="text" class="form-control" name="job" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">company</label>
                                                <input type="input" class="form-control" name="company" required>
                                        ...
                                        <div class="row form-group">
                                              ...
                                              <div class="col-md-4">
                                                <label for="" class="control-label">your Image</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="input" class="form-control" name="number" required>
                                            ...
                                            <div class="col-md-5">
                                                <label for="" class="control-label">achivements</label>
                                                <textarea name="achive" id="" cols="30" rows="3" class="form-control"></textarea>
                                            </div>
                                            <div class="col-md-5">
                                                <label for="" class="control-label">experience</label>
                                                <textarea name="connect_to" id="" cols="30" rows="3" class="form-control"></textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                ...
                                                <a class=" button btn btn-primary" href="index.php" rol#e="button">back</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
